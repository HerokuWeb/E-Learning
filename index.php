        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            ...
            <div class="pm-staff-profile-details text-center">
              ...
              <p class="pm-staff-profile-title">Supervisor</p>

              <p class="pm-staff-profile-bio">"Jangan hanya karena kesibukan, kita lupa ibadah dan keluarga." </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            ...
            <div class="pm-staff-profile-details text-center">
              ...
              <p class="pm-staff-profile-bio">"Seseorang yang luar biasa itu sederhana dalam ucapannya, tetapi hebat dalam tindakannya.". </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            <div class="pm-staff-profile-image-wrapper text-center">
              <div class="pm-staff-profile-image">
                <img src="img/fandy.jpg" alt="" class="img-thumbnail img-circle " style = height = 380px, width = 380px />
              </div>
            </div>
            <div class="pm-staff-profile-details text-center">
              <p class="pm-staff-profile-name">Adilla Ihza Fandy</p>
              <p class="pm-staff-profile-title">Director</p>

              <p class="pm-staff-profile-bio">"Sadar akan kekurangan lebih baik daripada bangga akan kelebihan." </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="text-comment">
            <p class="text-par">"Hidup itu sederhana, kita yang membuatnya sulit."</p>
            <p class="text-name">-Confucius</p>
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
          <div class="text-comment">
            <p class="text-par">"Hidup itu bukan soal menemukan diri Anda sendiri, hidup itu membuat diri Anda sendiri."</p>
            <p class="text-name">-George Bernard Shaw</p>
          </div>
        </div>
      </div>
    </div>
